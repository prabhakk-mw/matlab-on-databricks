...
import aiohttp
from aiohttp import CookieJar, client_exceptions, web
        ...
        async with aiohttp.ClientSession(
            ...
            try:
                ...
                async with client_session.request(
                    ...
                    for cookie in req.app['cookie_jar']:
                        headers.add('Set-Cookie', cookie.output(header=''))
...
def configure_and_start(app):
    ...
    app['cookie_jar'] = CookieJar(loop=loop, unsafe=True)
